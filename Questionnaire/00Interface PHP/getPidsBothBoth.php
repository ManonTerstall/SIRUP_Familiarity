<?php
	foreach($likePids as $pid){
		$query="SELECT Pid1, Similarity FROM  `LDandMetadata recommendations` where Pid2= '".$pid."' UNION SELECT Pid2, Similarity FROM `LDandMetadata recommendations` where Pid1= '".$pid."'";
